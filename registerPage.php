...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent ">
        <div class="container mt-3 mb-4">
            <a class="navbar-brand" href="#" style=" font-size: 20px; font-weight: 600; font-family: Georgia, 'Times New Roman', Times, serif;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown" >
                <ul class="navbar-nav ms-auto" style="font-weight: bolder;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" href="loginPage.php">Log Out</a>
                    </li>
                </ul>
            </div>
        </div>
